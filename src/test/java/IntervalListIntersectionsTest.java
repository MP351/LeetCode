...
public class IntervalListIntersectionsTest {
    ...
    public void intervalTest1() {
        Interval[] A = new Interval[] { new Interval(0, 2), new Interval(5, 10), new Interval(13, 23),
                new Interval(24, 25)};
        Interval[] B = new Interval[] { new Interval(1, 5), new Interval(8, 12), new Interval(15, 24),
                new Interval(25, 26)};
